...
class User(object):
    ...
    def first_name(self, newName):
        ...
        if not m:
            ...
            raise NotLanguageCharacterError(newName)
    ...
    def email(self, newEmail):
        ...
        if m:
            ...
            print('the email is changed')
        else:
            raise NotEmailPatternError(newEmail)
...
class NotLanguageCharacterError(ValueError):
    pass


class NotEmailPatternError(ValueError):
    pass
...
except NotLanguageCharacterError:
    print('shoul be language character')
